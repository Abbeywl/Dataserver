<template>
	<view class="body">
		...
		<view class="top_head">
			<view class="text_des">			
				<text class="month_text">李永乐</text>
				<text class="title">用户信息报告</text>
			</view>
			<view class="top_desc">
				<view class="text-gray">姓名</view>
				<view class="remaining">李永乐</view>
				<view class="row head_block">
					<view class="flex_1">
						<text class="text-gray">车型：</text>
						<text class="text_green">劳斯拉斯-库里南</text>
					</view>
					<view class="flex_1">
						<text class="text-gray">车联网编号：</text>
						<text class="income">123456789</text>
					</view>
				</view>
			</view>
		</view>
		<view class="main">
			...
			<view class="row_block">
				<view class="the_title">
					<view class="title_icon"></view>
					<text class="margin_stand-samll font-big wide">数据分析</text>
				</view>
				<view v-if="delayload" class="charts-box">
					<qiun-data-charts type="ring" canvasId="finance_b" :canvas2d="isCanvas2d" :resshow="delayload"
						:opts="{padding:[15,0,4,0],legend:{position: 'bottom'},title:{name: expendCount},subtitle: {name: '分析',fontSize:'20'}}"
			...
			<view class="row_block">
				<view class="the_title">
					<view class="title_icon"></view>
					<text class="margin_stand-samll font-big wide">{{nowTime.month}}月车联网在线时间</text>
				</view>
	...
	export default {
		...
		data() {
			return {
				...
				extend_morethan:"68%",
				detail_list:[
					{date:now_time.month + "-01",time:"11:01","type":"extend",money:"1:00",desc:"地址：中山南路"},
					{date:now_time.month + "-01",time:"13:45","type":"income",money:"2:00",desc:"地址：北京路"},
					{date:now_time.month + "-02",time:"06:21","type":"extend",money:"3:45",desc:"地址：外滩"},
					{date:now_time.month + "-03",time:"07:38","type":"income",money:"4:00",desc:"地址：南京东路"},
					{date:now_time.month + "-08",time:"16:28","type":"extend",money:"3:56",desc:"地址：苏州花园南路"},
					{date:now_time.month + "-09",time:"15:25","type":"income",money:"5:12",desc:"地址：上海路"},
					{date:now_time.month + "-09",time:"18:52","type":"income",money:"1:88",desc:"地址：芦潼路"},
					{date:now_time.month + "-11",time:"21:12","type":"extend",money:"2:21",desc:"地址：中铁大厦西门"},
					{date:now_time.month + "-12",time:"13:08","type":"income",money:"3:28",desc:"地址：首钢俱乐部"},
					{date:now_time.month + "-12",time:"12:41","type":"extend",money:"12:12",desc:"地址：人民大会堂"},
					{date:now_time.month + "-13",time:"17:21","type":"income",money:"10:00",desc:"地址：天安门"},
				]
			};
		},
		watch: {
