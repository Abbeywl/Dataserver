		...
		<view class="data_body">
			<scroll-view class="scroll_list" scroll-y :style="{height:scrollHeight}">
				...
				<view class="view_block">
					<view class="title">新媒体投放情况</view>
					<progress-bar :content="RankData" @updateRanking="updateRanking"></progress-bar>
				</view>
				
				<view class="view_block">
					<view class="title">浏览时间分布图
						<text class="font-small" style="color: #ccc;">(潜在客户数量)</text>
					</view>
				...
				<view class="view_block">
					<view class="title">感兴趣种类分布图
						<text class="font-small" style="color: #ccc;">(分类)</text>
					</view>
					<view class="charts-box">
					  <qiun-data-charts
					    type="radar"
				...
				<view class="view_block">
					<view class="title">新媒体客户转换率</view>
